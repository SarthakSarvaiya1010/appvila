...
import {FaFacebookF , FaTwitter , FaInstagram , FaLinkedin , FaYoutube , FaPinterest} from "react-icons/fa"
                ...
                <Row>
                    ...
                    <div>
                        ...
                        <div className='social'>
                            <a href="javascript(0)"><FaFacebookF />  </a>
                            <a  href='javascript(0)'> <FaTwitter /></a>
                            <a  href='javascript(0)'> <FaInstagram /> </a>
                            <a  href='javascript(0)'> <FaLinkedin /></a>
                            <a  href='javascript(0)'><FaYoutube /></a>
                            <a  href='javascript(0)'><FaPinterest /></a>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <li>
                            ...
                            <li>
                            <a href='javascpirt:video(0)'>Promotion</a>
v
                        </li>
                        </ul>
                    </div>

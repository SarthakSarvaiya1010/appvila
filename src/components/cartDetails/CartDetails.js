                    ...
                    <div>
                        {
                            alerted === "delete" ?
                                <div className="alert alert-success alert-dismissible d-flex align-items-center fade show">
                                    <div className="bi-check-circle-fill" style={{ fontSize: "1.5em", lineHeight: "1" }} ></div>
                    ...
                    {cart_data.cartTotal !== 0 ? (
                        <div>
                            {alerted === "Success" ?
                                <div className="alert alert-success alert-dismissible d-flex align-items-center fade show">
                                    <div className="bi-check-circle-fill" style={{ fontSize: "1.5em", lineHeight: "1" }} ></div>
                                    <strong className="mx-2">Success!</strong> Coupon code applied successfully..
                                </div> : null
                            }
                            {alerted === "applied" ?
                            ...
                            {alerted === "remove" ?
                                <div className="alert alert-success alert-dismissible d-flex align-items-center fade show">
                                    <strong className="mx-2">Success!</strong> Coupon has been removed..
                                </div> : null
                            }
                            {
                                alerted === "wrong" ?
                                    ...
                                    <Col md={4}>
                                        <div>
                                            ...
                                            <div>
                                                {apply_coupon ? (
                                                    <h4>
                                                        ${cart_data.cartTotal - apply_coupon.amount}
                                                        .00
                                                    </h4>
                                                ) : (
                                                    <h4>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <NavLink  >
                                        <h4 onClick={handlestateCheckout}>Proceed to checkout <FaArrowRight /></h4>
                                    </NavLink>
                                </div>
                            </div>
                        </div>

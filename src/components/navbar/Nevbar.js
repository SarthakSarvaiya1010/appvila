...
function Nevbar() {
  ...
  let itemTotal = cart_data.itemTotal;
  let cartTotal = cart_data.cartTotal;
          ...
          <Row>
            <Navbar className="contner">
              <Nav className="cont-logo">
                <NavLink to="/loginPage" className="navText">
                  Sarthak
                </NavLink>
              </Nav>
              <Nav className="cont-text">
                ...
                <NavLink className="navText" to="/receivedOrder">Blog</NavLink>
                <Nav>
          ...
          <div className={isHovering ? "hovering" : "noneHovering"}>
            <div className="cartDiters">
              <Card>
                ...
                {cartTotal !== 0 ? (
                  <Button className="buttnCart" onClick={handlestateCart}>
                    View to Cart
                  </Button>
                ) : (
                  ""
